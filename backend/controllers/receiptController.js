...
// @desc    Scan a receipt and return extracted data (no transaction creation)
...
const scanReceipt = async (req, res) => {
  ...
  try {
    ...
    const parsedData = {
      total: extractedData.amount || null,
      date: extractedData.date || null,
      vendor: extractedData.merchant || 'Unknown',
      category: extractedData.category || 'Miscellaneous',
      fullText: raw // Send full text for debugging or future use
    };
