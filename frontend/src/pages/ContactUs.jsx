  ...
  const contactMethods = [
    {
      ...
      details: "support@receiptwise.com",
      action: "mailto:support@receiptwise.com",
    },
    {
      icon: (
        <svg
...
const faqs = [
  {
    question: "Is my financial data secure on ReceiptWise?",
    answer:
      "Yes. ReceiptWise uses advanced encryption (AES-256) and secure HTTPS connections to protect your data. All personal and financial details are encrypted both in transit and at rest. We never share or sell your data to anyone.",
  },
  {
    question: "Can I scan and upload receipts using ReceiptWise?",
    answer:
      "Absolutely! ReceiptWise integrates Google Gemini AI for OCR-based receipt scanning. Just upload a photo of your receipt, and the app automatically extracts merchant name, amount, and date, then categorizes it as a transaction.",
  },
  {
    question: "Do I need to pay to use ReceiptWise?",
    answer:
      "No. ReceiptWise is completely free to use for personal finance tracking. In future, we may introduce optional premium features like multi-account analytics or AI-based financial insights.",
  },
  {
    question: "Can I access my account from multiple devices?",
    answer:
      "Yes. ReceiptWise is a web-based app, so you can securely log in from any device—desktop, tablet, or mobile browser. Your data stays synced across all devices automatically.",
  },
  {
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl p-8 mb-8 border border-white/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end">
                    <button
                      type="submit"
                      className="btn btn-primary inline-flex justify-center py-3 px-8 text-base font-medium"
                    >
                      Send Message
                    </button>
                  </div>
